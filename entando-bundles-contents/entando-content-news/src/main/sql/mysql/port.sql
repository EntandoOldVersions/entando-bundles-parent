...
INSERT INTO contentmodels (modelid, contenttype, descr, model, stylesheet) VALUES (1000x, 'NWS', 'My Content Model', 'here the content model velocity snippet', 'contentmodels/NWS.css');
